...
import * as vue$1 from 'file:///home/saurabh/Saharsh%20Software/united-meetup/node_modules/vue/index.mjs';
...
var FileUploadStyle = BaseStyle__default$4["default"].extend({
  name: 'fileupload',
  classes: classes$4
});
...
const styles = [
  ,
  BaseStyle$7 && BaseStyle$7.getStyleSheet ? BaseStyle$7.getStyleSheet(undefined, styleProps) : '',BaseComponentStyle$1 && BaseComponentStyle$1.getStyleSheet ? BaseComponentStyle$1.getStyleSheet(undefined, styleProps) : '',FileUploadStyle$1 && FileUploadStyle$1.getStyleSheet ? FileUploadStyle$1.getStyleSheet(undefined, styleProps) : '',ToastStyle$1 && ToastStyle$1.getStyleSheet ? ToastStyle$1.getStyleSheet(undefined, styleProps) : '',BadgeDirectiveStyle$1 && BadgeDirectiveStyle$1.getStyleSheet ? BadgeDirectiveStyle$1.getStyleSheet(undefined, styleProps) : '',TooltipStyle$1 && TooltipStyle$1.getStyleSheet ? TooltipStyle$1.getStyleSheet(undefined, styleProps) : '',RippleStyle$1 && RippleStyle$1.getStyleSheet ? RippleStyle$1.getStyleSheet(undefined, styleProps) : '',StyleClassStyle$1 && StyleClassStyle$1.getStyleSheet ? StyleClassStyle$1.getStyleSheet(undefined, styleProps) : '',FocusTrapStyle$1 && FocusTrapStyle$1.getStyleSheet ? FocusTrapStyle$1.getStyleSheet(undefined, styleProps) : '',AnimateOnScrollStyle$1 && AnimateOnScrollStyle$1.getStyleSheet ? AnimateOnScrollStyle$1.getStyleSheet(undefined, styleProps) : ''
].join('');

const defineNitroPlugin = (def) => def;
const _rwqgg42b80 = defineNitroPlugin(async (nitroApp) => {
