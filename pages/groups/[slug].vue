...
const { data: user, refresh, pending, status } = await useAsyncData(NUXT_ASYNC_DATA_KEY.HOME_PAGE_GROUP_DETAIL, () => fetchGroupDetailService({ id: route.params.slug?.toString() }))
